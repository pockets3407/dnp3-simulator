...
namespace Automatak.Simulator.DNP3.Components
{
    public partial class TemplateControl : UserControl
    {
        ...
        public void SetRecords(IEnumerable<EventConfig> records)
        {
