...
namespace Automatak.Simulator.DNP3.Components
{
    ...
    public partial class ScanDialog : Form
    {
        ...
        {            
            master.Scan(GetClassHeaders(classFieldControlScan.ClassFieldValue), PrintingSOEHandler.Instance, TaskConfig.Default);
        }
        ...
        private void buttonBind_Click(object sender, EventArgs e)
        {
            ...
            var info = new ScanInfo(master.AddScan(headers, period, PrintingSOEHandler.Instance, TaskConfig.Default), ClassDescription(classes), period, DetailedDescription(headers));
            this.scans.Add(info);
